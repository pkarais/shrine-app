...
import { Wrench, Clock, CheckCircle2, AlertTriangle, User, RefreshCw, Handshake } from "lucide-react"
        ...
        <div className="px-4 pb-4 pt-2 border-t border-[var(--outline-variant)]/20 space-y-3">
          ...
          <div className="flex flex-col gap-2 pt-2">
            ...
            {mode === "manager" && ticket.assigned_to && (
              <button
                onClick={() => startTransition(handleUnassign)}
                disabled={isPending}
            ...
            {(mode === "operations" || mode === "manager") && ticket.status === "in_progress" && (
              <button
                onClick={() => startTransition(handleComplete)}
                disabled={isPending}
