  ...
  return (
    <header className="fixed top-0 left-0 w-full z-[9999] bg-surface/95 dark:bg-slate-900/95 backdrop-blur-md px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center border-b border-[var(--outline-variant)]/20 dark:border-slate-700/30">
      <div className="flex items-center gap-3">
        <span className="material-symbols-outlined text-primary dark:text-[#d4a017]">account_balance</span>
        <div>
          <h1 className="font-headline text-base sm:text-lg font-bold text-primary dark:text-[#d4a017] tracking-tight leading-tight">Site Management</h1>
          {badge && (
      ...
      <div className="flex items-center gap-4">
        ...
        {showProfile ? (
          <div
            className="h-8 w-8 rounded-full bg-primary-container dark:bg-[#d4a017] text-white text-xs font-bold flex items-center justify-center"
            title={avatarLabel}
