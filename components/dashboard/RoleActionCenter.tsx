      ...
      <div className="flex gap-4 bg-surface-container-low p-2 rounded-2xl overflow-x-auto no-scrollbar">
        <button 
          ...
          className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-xl font-semibold transition-all ${
            activeTab === "action" ? "bg-primary text-on-primary" : "text-on-surface-variant hover:bg-surface-container"
          }`}
        >
        ...
        <button 
          ...
          className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-xl font-semibold transition-all ${
            activeTab === "ticket" ? "bg-primary text-on-primary" : "text-on-surface-variant hover:bg-surface-container"
          }`}
        >
        ...
        <button 
          ...
          className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-xl font-semibold transition-all ${
            activeTab === "history" ? "bg-primary text-on-primary" : "text-on-surface-variant hover:bg-surface-container"
          }`}
        >
        ...
        {isOperations && (
          <button 
            ...
            className={`flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-xl font-semibold transition-all ${
              activeTab === "workbench" ? "bg-primary text-on-primary" : "text-on-surface-variant hover:bg-surface-container"
            }`}
          >
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              {(isSecurity || isManager) && (
                <button 
                  ...
                  className="w-full p-6 bg-tertiary/5 rounded-[2rem] flex items-center justify-between group hover:opacity-80 transition-all"
                >
                  <div className="flex items-center gap-4">
                    <div className="p-3 bg-tertiary rounded-xl text-on-tertiary shadow-lg">
      ...
      {isWalkthroughOpen && (
        ...
        >
          <div className="min-h-full flex items-center justify-center p-6">
            <div className="w-full max-w-2xl bg-surface-container-lowest dark:bg-surface-container rounded-[2rem] p-8 shadow-2xl relative my-8">
