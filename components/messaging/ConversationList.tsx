...
export function ConversationList({
  ...
  function roleBadge(role: string | null) {
    switch (role?.toLowerCase()) {
      ...
      case "security":   return "bg-tertiary-container text-on-tertiary-container"
      case "operations": return "bg-primary-fixed text-on-primary-fixed"
      case "council":    return "bg-secondary-fixed text-on-secondary-fixed"
            ...
            return (
              ...
              >
                <div className="relative flex-shrink-0">
                  <div className="w-12 h-12 rounded-full sacred-gradient flex items-center justify-center text-white font-display font-bold text-sm">
                    {initials}
                  </div>
                  {isOnline(contact.id) && (
                    <span
