...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden bg-surface dark:bg-slate-900">
      ...
      <div className="relative z-10 w-full max-w-7xl px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="glass-panel dark:bg-slate-800/80 dark:border-slate-700/50 w-full max-w-md p-8 md:p-10 rounded-[2rem] shadow-2xl border border-white/20">
            <div className="mb-10">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="flex items-center justify-between py-2">
                ...
                <button
                  type="button"
                  className="text-sm font-semibold text-primary dark:text-[#d4a017] hover:text-primary-container transition-colors"
      ...
      {/* Footer / Legal */}
      <footer className="absolute bottom-8 w-full px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-white/50 dark:text-white/40 text-xs font-medium tracking-widest uppercase">
