...
export default function CouncilError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <main className="min-h-screen flex items-center justify-center bg-surface p-4">
      <div className="card-surface rounded-2xl p-8 max-w-md w-full text-center space-y-4">
        ...
        <h1 className="headline-sm text-on-surface">Council Dashboard Error</h1>
        <p className="body-md text-on-surface-variant">Failed to load council data. Please try again.</p>
        <button
          onClick={reset}
