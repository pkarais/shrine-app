      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="p-8 md:p-10 rounded-[2rem] shadow-2xl border border-white/20 glass-overlay">
          <div className="mb-10 text-center">
            ...
            <p className="text-on-surface-variant">Enter your email and we&apos;ll send you a reset link.</p>
          </div>

          {sent ? (
            <div className="bg-secondary-container text-on-secondary-container text-sm p-6 rounded-xl text-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label className="font-label text-xs font-bold text-primary tracking-widest uppercase ml-1 block">Email</label>
